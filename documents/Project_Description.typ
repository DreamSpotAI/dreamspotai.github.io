...
Finally, according to #link("https://www.technavio.com/report/travel-market-industry-analysis?utm_source=prnewswire&utm_medium=pressrelease&utm_campaign=aitrend1_1_report_week05_2025&utm_content=IRTNTR71431")[technavio.com], the travel market size is suggested to increase by $dollar$2860.2 billion between 2023 and 2028, therefore qualifying as a significant growing market.
  ...
  Regarding relevant costs, the DreamSpot team decided to #link("www.marcaria.com/register/trademarkprices.asp?country=USA")[register its trademark] in the US and subsidize users with a lottery of 10 premium plans. Another significant outcomes are Google Gemini fees which have been approximated to US $dollar$0,00075 per request. This price is multiplied by 200, estimation of requests for a complete travel planning procedure.
  ...
  With an initial investment of US $dollar$10.251, the platform will become profitable from the third year, estimating a US $dollar$21.722 EBITDA.

  Finally, thanks to advertisements about the platform for all the initial three years, the partnership with two influencers during the first year, and the 1-year hiring of an employee for the marketing segment during the second year, the DreamSpot team plans to get a total of 2000 users the first year, 4200 the second year, and 5700 the third year.
